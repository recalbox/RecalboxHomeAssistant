...
- [#10](https://github.com/recalbox/RecalboxHomeAssistant/issues/10) Disable in-game buttons for incompatible emulators (`ppsspp` for now)
...
- Ignore case on `Kodi` console name to ensure its consistency between polling, script, and other methods
